...
FONTS = {
    ...
    "dfont": ImageFont.truetype("PURVIMUSIC/assets/font2.otf", 12),
    "nfont": ImageFont.truetype("PURVIMUSIC/assets/font.ttf", 10),
    "tfont": ImageFont.truetype("PURVIMUSIC/assets/font.ttf", 20),
}
...
async def gen_thumb(song: videoid) -> str:
    """
